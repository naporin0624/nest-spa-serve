...
var ClientProvider = /** @class */ (function () {
    ...
    ClientProvider.prototype.register = function (app, config) {
        return __awaiter(this, void 0, void 0, function () {
            var compiler;
            return __generator(this, function (_a) {
                compiler = webpack_1.default(__assign(__assign({}, config), { mode: "development", plugins: __spreadArrays((config.plugins || []), [
